...
from common.config.config_prod import Config
...
SECRET_KEY = 'django-insecure-**c78r+eu+hw2a8sw3_m)ai1b-3@+ra31)a4w%m^9+&41(zc57'
...
STATIC_ROOT = '/opt/portfoliov2/static_files'
